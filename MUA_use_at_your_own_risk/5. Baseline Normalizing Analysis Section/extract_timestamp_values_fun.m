function extracted_time_stamps = extract_timestamp_values_fun(spike_density, before_timestamp_range, after_timestamp_range, time_stamps, file_directory);

% Get the row and column information for the "time_stamps" variable
[row_time_stamps, ~] = size(time_stamps);
