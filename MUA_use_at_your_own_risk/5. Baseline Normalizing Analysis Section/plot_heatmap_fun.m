function plot_heatmap_fun(density_matrix, particular_file_name, file_directory)
...
check_if_folder_exists(strcat(file_directory, 'figures/AllElectrodes/'));
...
colorbar;
filename = strcat(file_directory, 'figures/AllElectrodes/', particular_file_name, '.png');
saveas(gcf, filename);
