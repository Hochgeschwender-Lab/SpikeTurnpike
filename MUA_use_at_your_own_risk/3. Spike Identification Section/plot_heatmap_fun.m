...
% start_time = column_density_matrix - 1200;
% time_span = column_density_matrix - 1000;

time = start_time:time_bins:time_span; % s
% time = start_time:time_bins:time_rn; % s
% density_matrix = density_matrix(:, start_time:time_span);
