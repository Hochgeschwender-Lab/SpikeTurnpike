function mea_downsample_data_fun(downsampling_factor, h5_file_directory, file_directory_to_save_data)
...
%% Receive data from the mea_h5_to_mat function.
%{
    This step calls a function "mea_h5_to_mat_fun" to access the h5 data. The
...
electrode_data_original = mea_h5_to_mat_fun(h5_file_directory);
...
% Save the original .mat data.
save(strcat(file_directory_to_save_data, 'allData/electrode_data_original.mat'),...
    'electrode_data_original', '-v7.3')
