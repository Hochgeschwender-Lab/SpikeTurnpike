...
for ii = 1:numfolders
    ...
    for n_folders=1:total_number_of_files_to_extract_from
        ...
        if isfile(fullfile(file_directory_to_save_data,'allData',"reordered_electrode_data_downsampled.mat"))
            ...
            electrode_data_downsampled = electrode_data_downsampled(1:60, :); %60 channels
            ...
            % no re-odering is needed here for MEA. All that is being done is resaving the same file 
            % called "electrode_data_downsampled.mat"  to
            % "reordered_electrode_data_downsampled.mat" in order to be
            % consistent in the pipeline 
            
            reordered_electrode_data_downsampled = load(strcat(file_directory_to_save_data, 'allData/electrode_data_downsampled.mat'));
