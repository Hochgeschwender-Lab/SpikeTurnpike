function [electrode_number_accept, electrode_number_reject] = noise_removal_fun(electrode_data_downsampled, file_directory_to_save_data)

%% Get row and column information of the channel_data
[row_downsampled, ~] = size(electrode_data_downsampled);
...
%{
    ...
    contacts were marked as noise.file_directory_to_save_data
%}
...
writematrix(electrode_number_accept, strcat(file_directory_to_save_data, 'electrode_number_accept.csv'));
writematrix(electrode_number_reject, strcat(file_directory_to_save_data, 'electrode_number_reject.csv'));
